...
{
    public partial class frmUpdateNhuCauVonHangNamDauNam : GGScreenDetail
    {
        ...
        public frmUpdateNhuCauVonHangNamDauNam(NhuCauKeHoachVonChiTietDto nhuCauKeHoachVonChiTietDto)
        {
            InitializeComponent();
            ...
            GetValueControl();
            InitBindEntityToControl(this.Controls, nhuCauKeHoachVonChiTietDto);
            SetTextGroup();
        }
