...
{
    public partial class frmUpdateNhuCauVonHangNamDieuChinh : GGScreenDetail
    {
        ...
        public frmUpdateNhuCauVonHangNamDieuChinh(NhuCauKeHoachVonChiTietDto nhuCauKeHoachVonChiTietDto)
        {
            InitializeComponent();
        ...
        {
            box_LuyKeKhoiLuong.Text += " " + (_mainObject.DenNam - 1).ToString();
            box_LuyKeVon.Text += " " + (_mainObject.DenNam - 1).ToString();
            box_DeXuat.Text += " " + (_mainObject.DenNam).ToString();
            box_KeHoachVon.Text += " " + (_mainObject.DenNam).ToString();
        }
