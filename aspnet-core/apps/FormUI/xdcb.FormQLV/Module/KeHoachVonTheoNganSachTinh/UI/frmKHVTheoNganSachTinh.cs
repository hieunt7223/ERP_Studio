...
{
    public partial class frmKHVTheoNganSachTinh : GGScreen
    {
        #region Property
        private KeHoachVonNSTDto _mainObject;
        #endregion
        public frmKHVTheoNganSachTinh()
        {
            InitializeComponent();
            GetDataSearch();
            GetValueControl();
        ...
        {
            string path = ConfigManager.PathGridViewXML() + ModuleName.KHVTheoNganSachTinh + @"\" + TemplateDesignGrid.GridView_KeHoachVonTheoNganSachTinh.ToString();
            grd_KeHoachVonTheoNganSachTinh.InitializeControlByDesign(path, CreateDesignGrid.NewGridView.ToString());

            GridView gridview = (GridView)grd_KeHoachVonTheoNganSachTinh.MainView;
        ...
        private void Gridview_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                _mainObject = (KeHoachVonNSTDto)dgvSearchResults.GetRow(dgvSearchResults.FocusedRowHandle);
            }
        }

        private void Gridview_CustomColumnDisplayText(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs e)
        {
            if (e.Column.FieldName == KeHoachVonNSTColumn.TrangThai.ToString())
            {
                if (e.Value != null)
                {
            ...
            if (e.Column.FieldName == KeHoachVonNSTColumn.LoaiKeHoach.ToString())
            {
                if (e.Value != null)
                {
        ...
        public void GetDataSearch()
        {
            ...
            grd_KeHoachVonTheoNganSachTinh.DataSource = data;
            grd_KeHoachVonTheoNganSachTinh.RefreshDataSource();
        }
        #endregion
        ...
        private async void btn_New_Click(object sender, EventArgs e)
        {
            ...
            KeHoachVonNSTDto obj = new KeHoachVonNSTDto();
            var api = ConfigManager.GetAPIByService<IKeHoachVonNSTsApi>();
            ...
            frmCreateKHVTheoNganSachTinh guinew = new frmCreateKHVTheoNganSachTinh(true, obj, this.Module);
            guinew.Module = this.Module;
            guinew.Text = string.Format(FormQLVLocalizedResources.TextPopUpKeHoachVonNST, FormQLVLocalizedResources.ActionCreate);
            guinew.ShowDialog();
            //Load lại dữ liệu
            GetDataSearch();
        }
        ...
        public void Edit()
        {
            ...
            {
                KeHoachVonNSTDto obj = _mainObject;
                frmCreateKHVTheoNganSachTinh guinew = new frmCreateKHVTheoNganSachTinh(false, _mainObject, this.Module);
                guinew.Module = this.Module;
                //guinew.Text = string.Format(FormQLVLocalizedResources.TextPopUpKeHoachVonNST, FormQLVLocalizedResources.ActionEdit);
                guinew.ShowDialog();

                grd_KeHoachVonTheoNganSachTinh.DataSource = null;
                grd_KeHoachVonTheoNganSachTinh.RefreshDataSource();
        ...
        public void SetFocusedRow(KeHoachVonNSTDto obj)
        {
            if (_mainObject != null && _mainObject.Id != Guid.Empty)
            {
                var list = (List<KeHoachVonNSTDto>)grd_KeHoachVonTheoNganSachTinh.DataSource;
        ...
        private int GoToPositionOfEntity(List<KeHoachVonNSTDto> list, KeHoachVonNSTDto obj)
        {
            int index = -1;
        ...
        public void Delete()
        {
            if (_mainObject != null && _mainObject.Id != Guid.Empty)
            {
                ...
                KeHoachVonNSTDto obj = api.GetAsync(_mainObject.Id).GetAwaiter().GetResult();
                if (obj != null && obj.Id != Guid.Empty)
                {
        ...
        public void DeleteKeHoachVonDauNam(Guid id)
        {
            ...
            apiDetatil.DeleteByKeHoachVonNSTId(id);
        }
        ...
        public void DeleteKeHoachVonDieuChinh(Guid id)
        {
            ...
            api.DeleteKeHoachVonNSTDieuChinh(id).GetAwaiter().GetResult();
            apiDetatil.DeleteDataDieuChinhByKeHoachVonNSTID(id);
        }
        #endregion
