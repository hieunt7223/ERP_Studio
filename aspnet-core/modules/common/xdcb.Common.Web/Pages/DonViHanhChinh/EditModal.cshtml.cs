...
namespace xdcb.Common.DanhMuc.DonViHanhChinhs
{
    public class EditModalModel : AbpPageModel
    {
        ...
        public EditModalModel(IDonViHanhChinhAppService donViHanhChinhAppService, IAuthorizationService authorization)
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            var donViHanhChinhDto = await _donViHanhChinhAppService.GetAsync(Id);
            DonViHanhChinh = ObjectMapper.Map<DonViHanhChinhDto, DonViHanhChinhViewModel>(donViHanhChinhDto);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (await _authorization.IsGrantedAsync(xdcbCommonPermissions.DonViHanhChinhPermission.Update))
            {
                ...
                await _donViHanhChinhAppService.UpdateAsync(Id, donViHanhChinhDto);
                return NoContent();
            }
