...
{
    public partial class addtablekehoachvontheoNSTW : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "KeHoachVonNSTWChiTiets",
                schema: "von",
                columns: table => new
                {
                    ...
                    KeHoachVonNSTWId = table.Column<Guid>(nullable: false),
                    LoaiKhoanId = table.Column<Guid>(nullable: false),
                    CongTrinhId = table.Column<Guid>(nullable: false),
                    LuyKeVonTongCong = table.Column<decimal>(type: "decimal(22,6)", nullable: false, defaultValue: 0m),
                    LuyKeVonNamTruoc = table.Column<decimal>(type: "decimal(22,6)", nullable: false, defaultValue: 0m),
                    NhuCauKeHoachVonNamNay = table.Column<decimal>(type: "decimal(22,6)", nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeHoachVonNSTWChiTiets", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "KeHoachVonNSTWs",
                schema: "von",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeHoachVonNSTWs", x => x.Id);
                });
        }
