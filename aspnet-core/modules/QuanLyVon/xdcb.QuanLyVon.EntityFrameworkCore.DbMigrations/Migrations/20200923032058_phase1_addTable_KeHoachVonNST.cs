...
{
    public partial class phase1_addTable_KeHoachVonNST : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "KeHoachVonNSTChiTiets",
                schema: "von",
                columns: table => new
                {
                    ...
                    KeHoachVonNSTId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeHoachVonNSTChiTiets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeHoachVonNSTs", x => x.Id);
                });
        }
